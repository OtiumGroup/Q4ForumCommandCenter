    ...
    <div className="flex min-h-svh w-full">
      ...
      <aside className="hidden w-64 shrink-0 flex-col bg-sidebar text-sidebar-foreground lg:flex">
        <div className="flex items-center gap-2 px-5 py-6">
          <div className="flex h-9 w-9 items-center justify-center rounded-full bg-sidebar-primary font-display text-sm font-semibold text-sidebar-primary-foreground">
            Q4
          </div>
      ...
      <div className="flex min-h-svh flex-1 flex-col">
        ...
        <header className="flex h-16 items-center justify-between border-b border-border bg-card px-4 lg:px-8">
          <div className="flex items-center gap-3 lg:hidden">
            ...
            <span className="font-display text-sm font-semibold">EO Q4 Forum</span>
          </div>
